...
describe("historia", () => {
  test("wyszukuje, wybiera i uruchamia akcje dla nagrania", async () => {
    ...
    render(<HistoryPage adapter={adapter} recordings={recordings} onRefresh={async () => undefined} />);
  ...
  test("blokuje usuwanie aktywnego nagrania", async () => {
    render(<HistoryPage adapter={adapterStub()} recordings={recordings} onRefresh={async () => undefined} />);
